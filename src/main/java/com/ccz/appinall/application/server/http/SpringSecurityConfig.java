package com.ccz.appinall.application.server.http;
...
import com.ccz.appinall.application.server.http.admin.business.service.UserDetailsServiceImpl;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	/*@Override	//in-memory-login
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/log/**").hasAnyRole("ADMIN","USER").
		and().formLogin();
	}
	@Autowired
